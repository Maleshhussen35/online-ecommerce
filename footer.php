						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>kenya</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+254  75688928</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>maleshhussen@gmail.com</a></li>
								</ul>
							</div>
						</div>
